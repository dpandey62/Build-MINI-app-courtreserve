...
import Support from "../Pages/Support/Support";
import Login from "../Pages/Login/Login";
import Register from "../Pages/Register/Register"; // Register import karein
// import DashboardHome from "../Pages/Dashboard/DashboardHome/DashboardHome";
// import DashboardLayout from "../Layouts/DashboardLayout";
//import Dashboards from "../Pages/Dashboards/Dashboard"; // Dashboards import karein
const router = createBrowserRouter([
  {
    path: "/",
    element: <Root />, // Isme Navbar aur Footer hota hai
    children: [
  ...
  // {
  //   path: "dashboard",
  //   element: <DashboardLayout />, // Alag Layout Dashboard ke liye (Sidebar wala)
  //   children: [
  //     {
  //       index: true, // Jab user /dashboard par jaye toh ye dikhega
  //       element: <DashboardHome />,
  //     },
  //     // Future mein aur pages yahan add honge (e.g., profile, bookings)
  //   ],
  // },
]);
