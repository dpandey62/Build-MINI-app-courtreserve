...
// //       {/* Agar Sidebar add karna ho toh yahan karein */}
// //       <div className="flex-1">
// //         <Outlet /> {/* Yahan aapka DashboardHome load hoga */}
// //       </div>
// //     </div>
// //   );
// // };
...
const DashboardLayout = () => {
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="fixed left-0 top-0 h-screen w-64 bg-black z-50">
        <Sidebar />
      </div>

      {/* ✅ SCROLLABLE CONTENT ONLY */}
      <div className="ml-64 flex-1 overflow-y-auto bg-gray-100">
        <Outlet />
      </div>
