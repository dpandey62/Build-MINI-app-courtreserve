...
const dummyCourts = [
  ...
  },
  {
    ...
    location: "Block C",
    pricePerSession: 400,
    image: "https://4.imimg.com/data4/NY/QH/MY-14059388/multisport-court.jpg",},
   {
    id: 4,
    name: "Badminton Prime Court",
    type: "Squash",
    location: "Block C",
    pricePerSession: 400,
    image: "https://www.pfs.sport/wp-content/uploads/2024/06/Al-Bustan-Padel-Courts-8-1-1024x768-1.jpeg",
  },
   {
    id: 5,
    name: "Squash Court C",
    ...
    location: "Block C",
    pricePerSession: 400,
    image: "https://img.olympics.com/images/image/private/t_s_pog_staticContent_hero_lg_2x/f_auto/primary/weyzoz6o394sxfkbest9",
  },
   {
    id: 6,
    name: "Squash Fitness Bay",
    type: "Tennis",
    location: "Block C",
    pricePerSession: 400,
    image: "https://media.istockphoto.com/id/654106838/photo/man-playing-badminton.jpg?s=612x612&w=0&k=20&c=MIwbniPBbxUz0ic-jdka9DmL0oCTtBC1YqVYf_LxDRA=",
  },
   {
    id: 7,
    name: "Squash Fitness Bay",
    ...
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 mt-2">
          Choose your court and book your slot instantly
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {dummyCourts.map((court) => (
          <div
            key={court.id}
            className="bg-black rounded-2xl shadow-lg hover:shadow-2xl transition overflow-hidden"
          >
            {/* Image */}
            <img
              src={court.image}
            ...
            <div className="p-6 space-y-3">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold text-[#FFE733]">
                  {court.name}
                </h2>

                <span className="flex items-center gap-1 bg-[#FFE733] text-black px-3 py-1 rounded text-sm font-medium">
              ...
              <button
                ...
                className="w-full bg-[#00FF00] text-black py-2 rounded-lg font-semibold flex items-center justify-center gap-2 hover:opacity-90 transition"
              >
                <FaCalendarCheck />
                Book Now
              </button>
