          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-5">
                <div className="bg-[#00d4ff] text-black p-4 rounded-full shadow-lg">
                  <FaPhoneAlt className="text-xl" />
                </div>
                <div>
                  <p className="text-gray-600">Phone</p>
                  <p className="font-semibold text-gray-800"> +91 6123456789</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">support@courtreserve.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800"> Jodhpur , Rajasthan, India - 342001</p>
                </div>
              </div>
            </div>
          </div>
